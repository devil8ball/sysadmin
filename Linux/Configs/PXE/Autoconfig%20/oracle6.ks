...
repo --nam=uek --baseurl=http://yum.oracle.com/repo/OracleLinux/OL6/UEKR4/x86_64
...
yum install -y man ntpdate ntp bind-utils nano nfs-utils cifs-utils dos2unix zip traceroute wget telnet mailx logwatch net-snmp net-snmp-utils
