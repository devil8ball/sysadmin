...
network  --hostname=coldfusion.dodifferent.it
timezone --utc UTC
...
yum install -y ntpdate ntp bind-utils nano nfs-utils cifs-utils kernel-ml dos2unix zip traceroute net-tools epel-release wget telnet ssmtp mailx iptables-services logwatch
...
/script/installer/install-coldfusion
%end
